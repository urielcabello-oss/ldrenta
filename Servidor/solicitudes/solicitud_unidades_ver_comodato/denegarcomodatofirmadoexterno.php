    ...
    if ($ejecutar) {
        ...
        try {
            ...
            $mail->Body = utf8_decode("
                ...
                El documento denominado <strong>COMODATO</strong> ha sido <strong>rechazado</strong> para la asignación externa de la siguiente unidad vehicular:<br><br>
                ...
                Asignado al usuario que no pertenece a la empresa: <strong>$nombre_1 $nombre_2 $apaterno $amaterno</strong><br><br>
