...
if (isset($_POST['selectmodelosasignacionexterna'])) {
    $id_modelo = $_POST['selectmodelosasignacionexterna'];
    ...
    if ($result->num_rows > 0) {
        ...
        while ($fila = $result->fetch_assoc()) {
            echo "<tr>
                ...
                <td>
                    <button class='btn btn-warning btn-sm btninfounidadasignacionexterna' data-id='" . $fila['id_unidad'] . "'>
