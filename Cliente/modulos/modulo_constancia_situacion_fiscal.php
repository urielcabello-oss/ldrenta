<div class="contenedoropcionesunidades">
    <h2 class="titulosletrasunidades text-nowrap">Registro constancias de situación fiscal</h2>
    ...
    <div class="contendortablaunidades" id="contendortablaunidades">
        ...
        <div style="float:right;">
                <button class="btn btn-primary btnabrirmodalagregarconstanciafiscal" id="btnabrirmodalagregarconstanciafiscal" name="btnabrirmodalagregarconstanciafiscal">Agregar nueva constancia</button>
            </div>
            ...
            <table class="table table-hover tablaunidades" id="tablaUnidades">
                ...
                <tbody>
                    <?php include("../../Servidor/solicitudes/constancias_situacion_fiscal/obtener_constancias_situacion_fiscal.php"); ?>
                </tbody>
            </table>
        </div>
    </div>

    <!----------------------------------------------------------------------- modal para agregar constancias de situacion fiscal nuevas ------------------------------------------------------------------->
    <!-- Modal -->
    <div class="modal fade modalagregarconstanciaiscal" id="modalagregarconstanciaiscal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body" id="modalagregarconstanciaiscalbody">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="btncerrarmodalagregarlicencia" data-bs-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary btnagregarconstanciafiscal" id="btnagregarconstanciafiscal">Agregar constancia</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../js/constancia_situacion_fiscal/constancia_situacion_fiscal.js"></script>